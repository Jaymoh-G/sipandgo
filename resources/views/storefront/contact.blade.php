...
<section class="contact py-80">
    <div class="container container-lg">
        ...
        <div class="text-center mb-80" data-aos="fade-up" data-aos-duration="400">
            <h3 class="text-heading mb-32">Follow Us</h3>
            <div class="d-flex align-items-center justify-content-center gap-16 flex-wrap">
